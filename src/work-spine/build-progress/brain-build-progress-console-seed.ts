...
export const BRAIN_BUILD_LATEST_CHANGE_SUMMARY = {
  title: 'Stage 21E — Sidebar / Process Library Separation Plan',
  relatedCommit: 'e77f4d1',
  whereToSee: BRAIN_BUILD_PROGRESS_ROUTE,
  whatChanged:
    'נוספה תוכנית הפרדה סטטית בין Professional Process Blueprints לבין אזורי Sidebar תפעוליים.',
  proofOfLife:
    'מה מוצג במסך: Stage 21E — Sidebar / Process Library Separation Plan מציג 23 planning rows: 13 movesToProcessLibrary, 8 staysInSidebar, 2 needsEldadDecision. כל שורה היא תכנון סטטי בלבד עם implementationAllowed:false ו־requiresEldadApproval:true.',
  stillBlocked: [
    '18D remains HOLD',
    ...
    'Stage 21E is a static sidebar separation planning layer only',
    'אין runtime agents',
  ...
  nextSafeStep: 'לבקש אישור נפרד לפני כל יישום בפועל של הפרדת Sidebar / Process Library.',
  safetyStatus: 'Stage 21E Sidebar Separation Plan — static planning only, implementationAllowed:false',
