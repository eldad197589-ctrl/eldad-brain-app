...
export const BRAIN_BUILD_LATEST_CHANGE_SUMMARY = {
  ...
  whatChanged:
    'נוספה מפת שיוך סטטית בין 30 הסוכנים הפנימיים לבין 13 תהליכי ה־Blueprint המקצועיים.',
  proofOfLife:
    'מה מוצג במסך: Stage 21D — Agent ↔ Process Assignment Map מציג 13 static assignments, קישור של 30 internal agents אל 13 process blueprints, operationalExecution:false ו־canRun:false. טרם ננעל ב־commit.',
  stillBlocked: [
    '18D remains HOLD',
    ...
    'Stage 21D is a static agent-process assignment layer only',
    'אין runtime agents',
  ...
  nextSafeStep: 'להשאיר את מפת השיוך כ־static preview only עד אישור נפרד לעדכון roadmap לאחר commit.',
  safetyStatus: 'Stage 21D Agent Process Assignment Map — static preview only, operationalExecution:false',
