/* ============================================
   FILE: letterTemplates.ts
   PURPOSE: Letter template data — all template definitions for document generation
   DEPENDENCIES: ./types, ./constants (common fields)
   EXPORTS: TEMPLATES
   ============================================ */
import {
  Clock, AlertTriangle, CreditCard, FileCheck, FileText, Shield,
} from 'lucide-react';
import type { LetterTemplate } from './types';
import { FIELD_DATE, FIELD_CLIENT_NAME, FIELD_CLIENT_ID, FIELD_SENDER } from './commonFields';

// #region Templates

/** TEMPLATES — Letter template data — all template definitions for document generation */
