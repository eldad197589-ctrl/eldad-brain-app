...
export const warCompensation: FlowchartData = {
  ...
  subtitle: 'תהליך מלא: מאיסוף אסמכתאות ועד הגשת תביעה לרשות המיסים — חרבות ברזל · צוק איתן · עם כלביא · שאגת הארי',
  steps: [
    {
  ...
  decisions: [
    {
      afterStep: 2,
      decision: {
        title: '🔀 מסלול פיצוי ושיטת הוכחה',
        branches: [
          { label: '🔴 מסלול אדום (רשמי)', sub: 'נזק עקיף — פיצוי על ירידת הכנסות, אובדן מחזור, הפסד רווח', type: 'no' },
          { label: '📊 שיטת חישוב: השוואת מחזורים', sub: 'ניתוח פנימי — חישוב ירידה במחזור עסקי', type: 'yes' },
          { label: '🔀 שיטת עבודה: הוכחה משולבת', sub: 'אסטרטגיה פנימית — עסקאות ספציפיות + ירידת מחזור', type: 'neutral' },
        ]
      }
    }
  ],
  result: {
    ...
    emphasis: 'חרבות ברזל · צוק איתן · עם כלביא · שאגת הארי · מסלול אדום (נזק עקיף) · תקדימים משפטיים ✓',
  }
};
